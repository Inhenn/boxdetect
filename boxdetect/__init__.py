...
def box_vertex(img, left_x1, left_x2, left_y1, left_y2, top_x1, top_x2, top_y1, top_y2,  bot_x1,
             bot_x2, bot_y1, bot_y2, right_x1, right_x2, right_y1,
             right_y2,line_num=None, left_length=None, right_length=None, top_length=None,
             bot_length=None, accuracy=None,allowed_error=None):
    ...
    for t in top:
        for l in left:
            for r in right:
                for b in bot:
                    if frame(t,l,r,b,allowed_error)!=0:
                        accuracy_list+=[frame(t,l,r,b,allowed_error)]
                        frame_list+=[(t,l,r,b)]
                        # print((t,l,r,b))
...
def box_draw(img, left_x1, left_x2, left_y1, left_y2, top_x1, top_x2, top_y1, top_y2,  bot_x1,
             bot_x2, bot_y1, bot_y2, right_x1, right_x2, right_y1,
             right_y2,line_num=None, left_length=None, right_length=None, top_length=None,
             bot_length=None, accuracy=None,allowed_error=None):
    if allowed_error is None:
...
def box_chop(img, left_x1, left_x2, left_y1, left_y2, top_x1, top_x2, top_y1, top_y2,  bot_x1,
             bot_x2, bot_y1, bot_y2, right_x1, right_x2, right_y1,
             right_y2,line_num=None, left_length=None, right_length=None, top_length=None,
             bot_length=None, accuracy=None,allowed_error=None):
    if allowed_error is None:
